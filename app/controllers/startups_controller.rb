class StartupsController < ApplicationController
  before_action :set_startup, only: [:leave, :join, :show, :edit, :update, :destroy]
  ...
  def create
    ...
    @startup.users << current_user #this adds the current user to the list of users for that startup
